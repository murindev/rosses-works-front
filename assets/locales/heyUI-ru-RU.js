            ...
            h: {
                ...
                validation: {
                    base: {
                        ...
                        maxLen: " количество символов более чем {value}",
                        minLen: " количество символов менее чем {value}",
                        max: " не более чем {value}",
                        min: " не менее чем {value}"
                    },
                    type: {
                        int: " не корректный формат числа",
                        number: " не корректный цифровой формат",
                        email: " не корректный формат email",
                        url: " не корректный формат url",
                        tel: " не корректный формат телефона",
                        mobile: " не корректный формат телефона",
                        globalmobile: " не корректный формат телефона"
                    }
                },
                date: {
                    today: "Сегодня",
